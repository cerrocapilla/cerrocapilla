...
const lugares = [
    ...
    iconos: [
        { nombre: "Restaurante", icono: "fa-utensils", color: "#D4A843" },
        { nombre: "Confitería", icono: "fa-cake-candles", color: "#D4A843" },
        { nombre: "Artesanías", icono: "fa-palette", color: "#D4A843" },
        { nombre: "Turismo Cultura", icono: "fa-landmark", color: "#D4A843" }
    ]
    ...
    },
    {
        ...
        metodoPago: ["Efectivo", "MercadoPago"],
        iconos: [
        { nombre: "Se Cobra Entrada", icono: "fa-dollar-sign", color: "#D4A843" },
        { nombre: "Actividad con Guía", icono: "fa-user-group", color: "#D4A843" }
    ]
    },
    {
        id: 5, 
    ...
    },
    {
        ...
        iconos: [
        { nombre: "Pileta", icono: "fa-swimming-pool", color: "#D4A843" },
        { nombre: "Camping", icono: "fa-campground", color: "#D4A843" },
        { nombre: "Proveduría", icono: "fa-store", color: "#D4A843" },
        { nombre: "Dormis", icono: "fa-bed", color:"#D4A843" },
        { nombre: "Asadores", icono: "fa-fire", color: "#D4A843" },
        { nombre: "Mesas", icono: "fa-chair", color: "#D4A843" },
        { nombre: "Cancha de Futbol", icono:"fa-futbol", color:"#D4A843" },
        { nombre: "Estacionamiento", icono: "fa-parking", color: "#D4A843" },
        { nombre: "Entrada Gratuita", icono:"fa-circle-check", color: "#D4A843" },
        { nombre: "Pet Friendly", icono: "fa-paw", color: "#D4A843" },
        { nombre: "Prohibido el consumo de bebidas Alcoholicas", icono: "fa-circle-xmark", color: "#D4A843" }
    ]
    },
    {
        id: 7, 
        ...
        { nombre: "Asadores", icono: "fa-fire", color: "#D4A843" },
        { nombre: "Actividad con Guía", icono: "fa-user-group", color: "#D4A843" },
        { nombre: "Juegos para Niños", icono: "fa-kite", color: "#D4A843" },
        { nombre: "Dormis", icono: "fa-bed", color:"#D4A843" },
        { nombre: "Cabalgatas", icono:"fa-horse", color: "#D4A843" },
        { nombre: "Proveduría", icono: "fa-store", color: "#D4A843" },
        { nombre: "Prohibido el consumo de bebidas Alcoholicas", icono: "fa-circle-xmark", color: "#D4A843" }
    ]
    },
    ...
    },
    {
        ...
        metodoPago: ["Efectivo", "MercadoPago", "Tarjeta"],
        iconos: [
        { nombre: "Trekking", icono: "fa-person-walking", color: "#D4A843" },
        { nombre: "Camino de Ripio", icono: "fa-road-barrier", color: "#D4A843" },
        { nombre: "Avistaje de Aves", icono: "fa-dove", color:"#D4A843" },
        { nombre: "Pet Friendly", icono: "fa-paw", color:"#D4A843" },
        { nombre: "Prohibido hacer Fuego", icono: "fa-circle-xmark", color: "#D4A843" },
        { nombre: "Prohibido el consumo de bebidas Alcoholicas", icono: "fa-circle-xmark", color: "#D4A843" }
    ]
    },
    {
        ...
        { nombre: "Se Cobra Entrada", icono: "fa-dollar-sign", color: "#D4A843" },
        { nombre: "Trekking", icono: "fa-person-walking", color: "#D4A843" },
        { nombre: "Meditación", icono: "fa-person", color: "#D4A843" },
        { nombre: "Confitería", icono: "fa-cake-candles", color: "#D4A843" },
        { nombre: "Restaurante", icono: "fa-utensils", color: "#D4A843" },
        { nombre: "Estacionamiento Pago", icono:"fa-square-parking", color: "#D4A843" },
        { nombre: "Asadores", icono: "fa-fire", color: "#D4A843" },
        { nombre: "Cabalgatas", icono:"fa-horse", color: "#D4A843" },
        { nombre: "Actividad con Guía", icono: "fa-user-group", color: "#D4A843" },
        { nombre: "Camino de Ripio", icono: "fa-road-barrier", color: "#D4A843" },
    ...
    // ===== DÓNDE DORMIR =====
    {
        ...
        metodoPago: ["Efectivo", "Tarjeta"],
        iconos: [
        { nombre: "Solo con Guía", icono: "fa-flag", color: "#D4A843" },
        { nombre: "Prohibido hacer Fuego", icono: "fa-circle-xmark", color: "#D4A843" },
        { nombre: "Trekking", icono: "fa-person-walking", color: "#D4A843" },
        { nombre: "Camino de Ripio", icono: "fa-road-barrier", color: "#D4A843" }
    ]
    },
    {
        ...
        { nombre: "Solo con Guía", icono: "fa-flag", color: "#D4A843" },
        { nombre: "Actividad con Guía", icono: "fa-user-group", color: "#D4A843" },
        { nombre: "Río", icono: "fa-water", color:"#D4A843"},
        { nombre: "Cabalgatas", icono:"fa-horse", color: "#D4A843" },
        { nombre: "Trekking", icono: "fa-person-walking", color: "#D4A843" },
        { nombre: "Meditación", icono: "fa-person", color: "#D4A843" },
        { nombre: "Avistaje de Aves", icono: "fa-dove", color:"#D4A843" },
        { nombre: "Dormis", icono: "fa-bed", color:"#D4A843" },
        { nombre: "Turismo Cultura", icono: "fa-landmark", color: "#D4A843" },
        { nombre: "Zona de observacion del Cielo Nocturno (a ojo desnudo)", icono: "fa-circle", color: "#D4A843" }
    ]
    },
    {
        id: 13, 
    ...
    },
    {
        ...
        { nombre: "Cabalgatas", icono:"fa-horse", color: "#D4A843" },
        { nombre: "Trekking", icono: "fa-person-walking", color: "#D4A843" },
        { nombre: "Pesca", icono: "fa-fish", color:"#D4A843" },
        { nombre: "Actividad con Guía", icono: "fa-user-group", color: "#D4A843" },
        { nombre: "Prohibido hacer Fuego", icono: "fa-circle-xmark", color: "#D4A843" },
        { nombre: "Camino de Ripio", icono: "fa-road-barrier", color: "#D4A843" },
        { nombre: "Pet Friendly", icono: "fa-paw", color:"#D4A843" },
    ...
    },
    {
        ...
        iconos: [
        { nombre: "Cabalgatas", icono:"fa-horse", color: "#D4A843" },
        { nombre: "Parapente", icono: "fa-parachute-box", color:"#D4A843" },
        { nombre: "Pileta", icono: "fa-swimming-pool", color: "#D4A843" },
        { nombre: "Trekking", icono: "fa-person-walking", color: "#D4A843" },
        { nombre: "Artesanías", icono: "fa-palette", color: "#D4A843" },
        { nombre: "Confitería", icono: "fa-cake-candles", color: "#D4A843" },
    ...
    },
    {
        ...
        iconos: [
        { nombre: "Río", icono: "fa-water", color:"#D4A843" },
        { nombre: "Sanitaríos", iconos:"fa-restroom", color:"#D4A843" },
        { nombre: "Mesas", icono: "fa-chair", color: "#D4A843" },
        { nombre: "Asadores", icono: "fa-fire", color: "#D4A843" },
        { nombre: "Estacionamiento", icono: "fa-parking", color: "#D4A843" },
        { nombre: "Se Cobra Entrada", icono: "fa-dollar-sign", color: "#D4A843" },
    ...
    },
    {
        ...
        metodoPago: ["Efectivo", "MercadoPago", "Tarjeta"],
        iconos: [
        { nombre: "Navegacion sin Motor", icono: "fa-sailboat", color: "#D4A843" },
        { nombre: "Pesca", icono: "fa-fish", color:"#D4A843" },
        { nombre: "Trekking", icono: "fa-person-walking", color: "#D4A843" },
        { nombre: "Proveduría", icono: "fa-store", color: "#D4A843" },
        { nombre: "Estacionamiento", icono: "fa-parking", color: "#D4A843" },
    ...
    },
    {
        ...
        iconos: [
        { nombre: "Trekking", icono: "fa-person-walking", color: "#D4A843" },
        { nombre: "Escalada", icono: "fa-person-hiking", color: "#D4A843" },
        { nombre: "Asadores", icono: "fa-fire", color: "#D4A843" },
        { nombre: "Proveduría", icono: "fa-store", color: "#D4A843" },
        { nombre: "Actividad con Guía", icono: "fa-user-group", color: "#D4A843" },
        { nombre: "Se Cobra Entrada", icono: "fa-dollar-sign", color: "#D4A843" },
...
function mostrarListaCercanos(cercanos) {
    ...
    const categoriasQuehacer = ['Turismo Aventura', 'Cultura', 'Camping', 'Oficina de Turismo', 'Bar', 'Entretenimiento', 'Senderismo', 'Iglesia', 'Gruta Religiosa', 'Camping', 'Balnerios', 'Reserva Natural', 'Biblioteca', 'Dique', 'Ferias', 'Club de Pesca'];
    ...
    /*if (listaDormir.children.length === 0) {
        listaDormir.innerHTML = '<p style="color:#8B6B4A;font-size:13px;padding:8px;"><a href="https://turismocapilla.gob.ar/donde-dormir/">Alojamientos Recomendados 🏡</a></p>';
    }*/
    /*if (listaComer.children.length === 0) {
        listaComer.innerHTML = '<p style="color:#8B6B4A;font-size:13px;padding:8px;">No hay lugares para comer cerca</p>';
            ...
            // AGREGAR MENSAJE CON ENLACE SIEMPRE (haya o no lugares para comer)
    const mensajeDormir = document.createElement('p');
        mensajeDormir.style.color = '#8B6B4A';
        mensajeDormir.style.fontSize = '13px';
        mensajeDormir.style.padding = '8px';
        mensajeDormir.style.marginTop = '10px';
        mensajeDormir.style.textAlign = 'center';

                // Crear el enlace
    const enlaceDormir = document.createElement('a');
        enlaceDormir.href = 'https://turismocapilla.gob.ar/donde-dormir';
        enlaceDormir.target = '_blank';
        enlaceDormir.rel = 'noopener noreferrer';
        enlaceDormir.textContent = 'Alojamientos Recomendados 🏡';
        enlaceDormir.style.color = '#2E7D32';
        enlaceDormir.style.fontWeight = 'bold';
        enlaceDormir.style.textDecoration = 'underline';
        enlaceDormir.style.cursor = 'pointer';

                // Agregar el enlace al mensaje
        mensajeDormir.appendChild(enlaceDormir);

                // Agregar al final de la lista (después de los lugares)
        listaDormir.appendChild(mensajeDormir);
            ...
            // AGREGAR MENSAJE CON ENLACE SIEMPRE (haya o no lugares para comer)
    const mensajeComer = document.createElement('p');
        mensajeComer.style.color = '#8B6B4A';
        mensajeComer.style.fontSize = '13px';
        mensajeComer.style.padding = '8px';
        mensajeComer.style.marginTop = '10px';
        mensajeComer.style.textAlign = 'center';

        // Crear el enlace
    const enlaceComer = document.createElement('a');
        enlaceComer.href = 'https://turismocapilla.gob.ar/donde-comer/';
        enlaceComer.target = '_blank';
        enlaceComer.rel = 'noopener noreferrer';
        enlaceComer.textContent = '🍽️ Conoce más';
        enlaceComer.style.color = '#2E7D32';
        enlaceComer.style.fontWeight = 'bold';
        enlaceComer.style.textDecoration = 'underline';
        enlaceComer.style.cursor = 'pointer';

// Agregar el enlace al mensaje
mensajeComer.appendChild(enlaceComer);

// Agregar al final de la lista (después de los lugares)
listaComer.appendChild(mensajeComer);
...
// ============================================================
//  17. NOTIFICACIONES - SISTEMA REWRITE COMPLETO
// ============================================================
...
// === FUNCIONES PARA LEÍDOS ===
function cargarLeidos() {
    try {
        const data = JSON.parse(localStorage.getItem('mis_leidos') || '{"eventos":[],"novedades":[],"noticias":[]}');
        return {
            eventos: new Set(data.eventos || []),
            novedades: new Set(data.novedades || []),
            noticias: new Set(data.noticias || [])
        };
    } catch (e) {
        return {
            eventos: new Set(),
...
function guardarLeidos(leidos) {
    try {
        ...
        localStorage.setItem('mis_leidos', JSON.stringify(data));
        console.log('💾 Leídos guardados:', data);
    } catch (e) {
...
// Inicializar leídos
let leidos = cargarLeidos();
console.log('📂 Leídos cargados - Noticias:', Array.from(leidos.noticias));
...
function recalcularTodasLasNotificaciones() {
    console.log('🔔 Recalculando todas las notificaciones...');
    
    const eventosNoLeidos = notificacionesConfig.eventos ? contarNoLeidos('eventos', eventos) : 0;
    const novedadesNoLeidas = notificacionesConfig.novedades ? contarNoLeidos('novedades', novedades) : 0;
    const noticiasNoLeidas = notificacionesConfig.noticias ? contarNoLeidos('noticias', noticias) : 0;
    
    notificacionesEstado.eventos = eventosNoLeidos;
    notificacionesEstado.novedades = novedadesNoLeidas;
    notificacionesEstado.noticias = noticiasNoLeidas;
    
    console.log('📊 Estado recalculado:', notificacionesEstado);
...
function actualizarBadges() {
    ...
    // Recalcular notificaciones no leídas
    const eventosNoLeidos = notificacionesEstado.eventos || 0;
    const novedadesNoLeidas = notificacionesEstado.novedades || 0;
    const noticiasNoLeidas = notificacionesEstado.noticias || 0;
    const total = eventosNoLeidos + novedadesNoLeidas + noticiasNoLeidas;
    
    console.log(`📊 Eventos: ${eventosNoLeidos}, Novedades: ${novedadesNoLeidas}, Noticias: ${noticiasNoLeidas}, Total: ${total}`);
    
    // Badges del menú inferior
    const menuBadges = [
        { id: 'menuBadgeEventos', contador: eventosNoLeidos },
        { id: 'menuBadgeNovedades', contador: novedadesNoLeidas },
        { id: 'menuBadgeNoticias', contador: noticiasNoLeidas }
    ];
    ...
    menuBadges.forEach(({ id, contador }) => {
        ...
        if (contador > 0) {
            ...
            console.log(`✅ Badge ${id}: ${contador}`);
        } else {
            badge.textContent = '0';
            badge.style.display = 'none';
            badge.style.visibility = 'hidden';
            badge.style.opacity = '0';
            console.log(`❌ Badge ${id}: 0`);
        }
    });
    
    // Badge de la campana (principal)
    const campana = document.getElementById('notificacionesBadge');
    if (campana) {
        console.log(`🔔 Actualizando campana con total: ${total}`);
        if (total > 0) {
            campana.textContent = total > 99 ? '99+' : total;
            ...
            campana.style.fontSize = '10px';
            campana.style.fontWeight = '700';
            campana.style.minWidth = '18px';
            campana.style.height = '18px';
            campana.style.borderRadius = '50%';
            campana.style.padding = '0 4px';
            campana.style.border = '2.5px solid white';
            campana.style.boxShadow = '0 2px 8px rgba(0,0,0,0.25)';
            ...
            console.log(`🔔 Campana: ${total}`);
        } else {
            campana.textContent = '0';
            campana.style.display = 'none';
            campana.style.visibility = 'hidden';
            campana.style.opacity = '0';
            console.log('🔔 Campana: 0');
        }
    } else {
        console.warn('⚠️ Campana no encontrada');
    }
}

// === RENDERIZAR SECCIONES ===
function renderizarEventos() {
    console.log('📅 renderizarEventos()');
    const contenedor = document.getElementById('listaEventos');
    if (!contenedor) return;
    contenedor.innerHTML = '';
    
    // Marcar como leídos
    eventos.forEach(e => leidos.eventos.add(e.id));
    guardarLeidos(leidos);
    notificacionesEstado.eventos = 0;
    actualizarBadges();
    
    if (eventos.length === 0) {
        contenedor.innerHTML = '<p style="text-align:center;color:#8B6B4A;padding:20px;">No hay eventos</p>';
        return;
    }
    ...
    document.querySelectorAll('.btn-ir').forEach(btn => {
        btn.addEventListener('click', function(e) {
            ...
            if (userLocation) {
                window.open(`https://www.google.com/maps/dir/${userLocation[0]},${userLocation[1]}/${lat},${lng}`, '_blank');
            } else {
...
function renderizarNovedades() {
    console.log('📰 renderizarNovedades()');
    const contenedor = document.getElementById('listaNovedades');
    if (!contenedor) return;
    contenedor.innerHTML = '';
    
    novedades.forEach(n => leidos.novedades.add(n.id));
    guardarLeidos(leidos);
    notificacionesEstado.novedades = 0;
    actualizarBadges();
    
    if (novedades.length === 0) {
        contenedor.innerHTML = '<p style="text-align:center;color:#8B6B4A;padding:20px;">No hay novedades</p>';
        return;
    }
...
function renderizarNoticias() {
    console.log('📰 renderizarNoticias()');
    ...
    let marcadas = 0;
    noticias.forEach(n => {
        if (!leidos.noticias.has(n.id)) {
            leidos.noticias.add(n.id);
            marcadas++;
        }
    });
    if (marcadas > 0) {
        console.log(`✅ ${marcadas} noticias marcadas como leídas`);
        guardarLeidos(leidos);
    }
    ...
    if (noticias.length === 0) {
        contenedor.innerHTML = '<p style="text-align:center;color:#8B6B4A;padding:20px;">No hay noticias</p>';
        return;
    }
...
function ocultarMenu(ocultar) {
    ...
    if (menu) {
        if (ocultar) menu.classList.add('oculto');
        else menu.classList.remove('oculto');
    }
}

function ocultarTodasSeccionesYMostrarMapa() {
    ['seccion-eventos', 'seccion-novedades', 'seccion-noticias', 'seccion-admin'].forEach(id => {
...
document.getElementById('btnVerNovedades')?.addEventListener('click', function() {
...
document.getElementById('btnVerNoticias')?.addEventListener('click', function() {
    document.getElementById('seccion-eventos').style.display = 'none';
    document.getElementById('seccion-novedades').style.display = 'none';
...
document.querySelector('.logo')?.addEventListener('dblclick', function(e) {
    ...
    if (adminClicks >= 2) {
        adminClicks = 0;
        const btn = document.getElementById('btnVerAdmin');
        if (btn) {
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Recargar leídos
    leidos = cargarLeidos();
    console.log('📂 Noticias leídas:', Array.from(leidos.noticias));
...
function ajustarBadgesParaMovil() {
    ...
    const badges = ['menuBadgeEventos', 'menuBadgeNovedades', 'menuBadgeNoticias'];
    badges.forEach(id => {
        const badge = document.getElementById(id);
        if (badge) {
            ...
            badge.style.top = sizes.top;
            badge.style.right = sizes.right;
...
// ============================================================
//  23. CONEXIÓN CON FIREBASE REALTIME DATABASE
// ============================================================
...
function mostrarNotificacionToast(mensaje) {
    ...
    if (!toast) {
        ...
        toast.style.cssText = `
            ...
            background: rgba(46,125,50,0.95); color: white; padding: 12px 24px;
            border-radius: 12px; font-size: 14px; font-weight: 600; z-index: 99999;
            max-width: 90%; text-align: center; transition: all 0.4s ease;
...
document.getElementById('btnNotificaciones')?.addEventListener('click', function(e) {
    ...
    if (!popup) {
        console.error('❌ Popup de notificaciones no encontrado');
        return;
    }
...
document.getElementById('notificacionesPopup')?.addEventListener('click', function(e) {
    if (e.target === this) {
...
document.getElementById('btnCerrarNotificaciones')?.addEventListener('click', function() {
    const popup = document.getElementById('notificacionesPopup');
    if (popup) {
        popup.style.display = 'none';
        popup.classList.remove('active');
...
function cargarConfigNotificaciones() {
    ...
    console.log('📋 Configuración cargada:', notificacionesConfig);
}
...
function guardarConfigNotificaciones() {
    ...
    // Recalcular badges con nueva configuración
    recalcularTodasLasNotificaciones();
    ...
    console.log('💾 Configuración guardada:', notificacionesConfig);
}
...
function conectarFirebase() {
    if (!window.firebaseDB || !window.firebaseHelpers) {
        ...
        setTimeout(conectarFirebase, 500);
        return;
    }
        ...
        if (data) {
            ...
            Object.values(data).forEach(item => {
                ...
                if (!eventos.find(e => e.id === id)) {
                    eventos.push(item);
                    if (!leidos.eventos.has(id)) nuevos++;
                }
            });
            if (nuevos > 0) {
                notificacionesEstado.eventos = nuevos;
    ...
    // NOVEDADES
    // ============================================================
    const novedadesRef = ref(window.firebaseDB, 'novedades');
    onValue(novedadesRef, (snapshot) => {
        ...
        if (data) {
            ...
            Object.values(data).forEach(item => {
                const id = parseInt(item.id);
                if (!novedades.find(n => n.id === id)) {
                    novedades.push(item);
                    if (!leidos.novedades.has(id)) nuevos++;
                }
            });
            if (nuevos > 0) {
                notificacionesEstado.novedades = nuevos;
                mostrarNotificacionToast('🔔 ¡Nuevas notificaciones!');
            } else {
                notificacionesEstado.novedades = 0;
            }
    ...
    // ============================================================
    const noticiasRef = ref(window.firebaseDB, 'noticias');
    onValue(noticiasRef, (snapshot) => {
        const data = snapshot.val();
        if (data) {
            console.log('📰 Noticias desde Firebase:', Object.keys(data));
            
            let nuevos = 0;
            Object.values(data).forEach(item => {
                const id = parseInt(item.id);
                if (!noticias.find(n => n.id === id)) {
                    noticias.push(item);
                    // ✅ SOLO contar si NO está en leídos
                    if (!leidos.noticias.has(id)) {
                        nuevos++;
                        console.log(`🆕 Noticia NUEVA: ${id}`);
                    } else {
                        console.log(`📰 Noticia ya leída: ${id}`);
                    }
                }
            });
            ...
            // ✅ Actualizar estado
            if (nuevos > 0) {
                notificacionesEstado.noticias = nuevos;
                mostrarNotificacionToast('🔔 ¡Nuevas notificaciones!');
            } else {
                notificacionesEstado.noticias = 0;
            }
            
            console.log('📊 Noticias nuevas:', nuevos);
            console.log('📝 Leídos:', Array.from(leidos.noticias));
...
// ============================================================
//  POP-UP / MARQUESINA - AGREGADO AL FINAL
// ============================================================
(function() {
    'use strict';
    ...
    const track = document.getElementById('popupSlidesTrack');
    const slides = track ? track.querySelectorAll('.popup-slide') : [];
    const prevBtn = document.getElementById('popupPrevSlide');
    const nextBtn = document.getElementById('popupNextSlide');
    const closeBtn = document.getElementById('closePopup');
    const dotsContainer = document.getElementById('popupDotsContainer');

    if (!overlay || !track || slides.length === 0) {
        console.warn('⚠️ Pop-up: elementos no encontrados');
        return;
    }

    let currentIndex = 0;
    let autoSlideInterval = null;
    //const AUTO_INTERVAL = 20000; // 20 segundos // este es el tiempo original
    const AUTO_INTERVAL = 2000; // 3 segundos
    ...
    const dots = dotsContainer ? dotsContainer.querySelectorAll('.popup-dot') : [];
    ...
    // Cerrar al hacer clic en el overlay (fuera del cartel)
    ...
    // --- Pausar auto-slide cuando la pestaña no está visible ---
    ...
    // Observar cambios en el overlay
    const observer = new MutationObserver(() => {
        preventBodyScroll(overlay.classList.contains('active'));
    });
    ...
    console.log('✅ Pop-up / Marquesina inicializado correctamente');
    console.log('📊 Slides cargados:', slides.length);
    console.log('🔄 Cambio automático cada', AUTO_INTERVAL / 1000, 'segundos');
