...
// ============================================================
//  25. CONEXIÓN CON FIREBASE - VERSIÓN SIMPLIFICADA
// ============================================================
...
function conectarFirebase() {
    ...
    onSnapshot(eventosRef, (snapshot) => {
        snapshot.docChanges().forEach((change) => {
            if (change.type === 'added') {
                ...
                console.log('📅 Nuevo evento:', nuevoEvento.nombre);
    ...
    onSnapshot(novedadesRef, (snapshot) => {
        snapshot.docChanges().forEach((change) => {
            if (change.type === 'added') {
                ...
                console.log('📰 Nueva novedad:', nuevaNovedad.nombre);
    ...
    onSnapshot(noticiasRef, (snapshot) => {
        snapshot.docChanges().forEach((change) => {
            if (change.type === 'added') {
                const nuevaNoticia = change.doc.data();
                console.log('📢 Nueva noticia:', nuevaNoticia.nombre);
