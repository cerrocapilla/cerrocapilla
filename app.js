...
// ============================================================
// 23.1 AJUSTAR BADGES PARA MÓVILES - VERSIÓN MEJORADA
// ============================================================
...
function ajustarBadgesParaMovil() {
    ...
    if (campana) {
        ...
        campana.style.letterSpacing = '0.5px';
...
console.log('✅ Badges ajustados para móviles con estilo moderno');
